...
export const events = {
    Approved: event("0x1718a64c060e83f86c815c1c1c305b016fd419f5d150962d0d6405761e74c5e4", "Approved(address,uint256,uint256,bytes32)", {"who": indexed(p.address), "fromBlock": p.uint256, "toBlock": p.uint256, "commitment": p.bytes32}),
    ApprovesRequiredChanged: event("0x82128e565cfc8353e79f542d7a277dfa675daed9c90a8b5321cc0363ff8a7370", "ApprovesRequiredChanged(uint256)", {"newApprovesRequired": p.uint256}),
    Claimed: event("0x987d620f307ff6b94d58743cb7a7509f24071586a77759b77c2d4e29f75a2f9a", "Claimed(address,uint256,uint256)", {"by": indexed(p.address), "worker": indexed(p.uint256), "amount": p.uint256}),
    Distributed: event("0xa4a6b2187ef1354bf92bcc14dc28e999e5ecb37642caa1a28205659068a104fa", "Distributed(uint256,uint256,uint256[],uint256[],uint256[])", {"fromBlock": p.uint256, "toBlock": p.uint256, "recipients": p.array(p.uint256), "workerRewards": p.array(p.uint256), "stakerRewards": p.array(p.uint256)}),
    DistributorAdded: event("0xddbf200aa634dc3fb81cfd68583dd1040d1c751d335e1d86b631bde3e977fea8", "DistributorAdded(address)", {"distributor": indexed(p.address)}),
    DistributorRemoved: event("0x126174f6cf49c81cdb4a9214c6b8f037bef55b4ec31e4fc776cea2a1c8a88d59", "DistributorRemoved(address)", {"distributor": indexed(p.address)}),
    NewCommitment: event("0x3d0e20f31408b190e11fe8ac40c73e8aca970b3f47c98f626c110d9fe0199707", "NewCommitment(address,uint256,uint256,bytes32)", {"who": indexed(p.address), "fromBlock": p.uint256, "toBlock": p.uint256, "commitment": p.bytes32}),
    ...
    RoundRobinBlocksChanged: event("0xe3af6ab99586802d1ac3592654adaba57091ee99ae93a64a092c813552591aab", "RoundRobinBlocksChanged(uint256)", {"newRoundRobinBlocks": p.uint256}),
    Unpaused: event("0x5db9ee0a495bf2e6ff9c91a7834c1ba4fdd244a5e8aa4e537bd38aeae4b073aa", "Unpaused(address)", {"account": p.address}),
    WindowSizeChanged: event("0xea307e5ee57372fa76a40fce652eb46a4f9fb1d64e42c3af1128a56729d30f65", "WindowSizeChanged(uint256)", {"newWindowSize": p.uint256}),
}

export const functions = {
    DEFAULT_ADMIN_ROLE: viewFun("0xa217fddf", "DEFAULT_ADMIN_ROLE()", {}, p.bytes32),
    PAUSER_ROLE: viewFun("0xe63ab1e9", "PAUSER_ROLE()", {}, p.bytes32),
    REWARDS_DISTRIBUTOR_ROLE: viewFun("0xc34c2289", "REWARDS_DISTRIBUTOR_ROLE()", {}, p.bytes32),
    REWARDS_TREASURY_ROLE: viewFun("0xb5b06781", "REWARDS_TREASURY_ROLE()", {}, p.bytes32),
    addDistributor: fun("0x7250e224", "addDistributor(address)", {"distributor": p.address}, ),
    alreadyApproved: viewFun("0x406e3090", "alreadyApproved(bytes32,address)", {"commitment": p.bytes32, "distributor": p.address}, p.bool),
    approve: fun("0x565b756a", "approve(uint256,uint256,uint256[],uint256[],uint256[])", {"fromBlock": p.uint256, "toBlock": p.uint256, "recipients": p.array(p.uint256), "workerRewards": p.array(p.uint256), "_stakerRewards": p.array(p.uint256)}, ),
    approves: viewFun("0x773b68c9", "approves(uint256,uint256)", {"fromBlock": p.uint256, "toBlock": p.uint256}, p.uint8),
    canApprove: viewFun("0x42bef350", "canApprove(address,uint256,uint256,uint256[],uint256[],uint256[])", {"who": p.address, "fromBlock": p.uint256, "toBlock": p.uint256, "recipients": p.array(p.uint256), "workerRewards": p.array(p.uint256), "_stakerRewards": p.array(p.uint256)}, p.bool),
    canCommit: viewFun("0xb278e358", "canCommit(address)", {"who": p.address}, p.bool),
    claim: fun("0x1e83409a", "claim(address)", {"who": p.address}, p.uint256),
    claimable: viewFun("0x402914f5", "claimable(address)", {"who": p.address}, p.uint256),
    commit: fun("0x6957bc60", "commit(uint256,uint256,uint256[],uint256[],uint256[])", {"fromBlock": p.uint256, "toBlock": p.uint256, "recipients": p.array(p.uint256), "workerRewards": p.array(p.uint256), "_stakerRewards": p.array(p.uint256)}, ),
    commitments: viewFun("0xd13e2e60", "commitments(uint256,uint256)", {"fromBlock": p.uint256, "toBlock": p.uint256}, p.bytes32),
    getRoleAdmin: viewFun("0x248a9ca3", "getRoleAdmin(bytes32)", {"role": p.bytes32}, p.bytes32),
    grantRole: fun("0x2f2ff15d", "grantRole(bytes32,address)", {"role": p.bytes32, "account": p.address}, ),
    hasRole: viewFun("0x91d14854", "hasRole(bytes32,address)", {"role": p.bytes32, "account": p.address}, p.bool),
    lastBlockRewarded: viewFun("0xeadf1f39", "lastBlockRewarded()", {}, p.uint256),
    pause: fun("0x8456cb59", "pause()", {}, ),
    paused: viewFun("0x5c975abb", "paused()", {}, p.bool),
    removeDistributor: fun("0x57c1f9e2", "removeDistributor(address)", {"distributor": p.address}, ),
    renounceRole: fun("0x36568abe", "renounceRole(bytes32,address)", {"role": p.bytes32, "callerConfirmation": p.address}, ),
    requiredApproves: viewFun("0x75ddfa41", "requiredApproves()", {}, p.uint256),
    revokeRole: fun("0xd547741f", "revokeRole(bytes32,address)", {"role": p.bytes32, "account": p.address}, ),
    roundRobinBlocks: viewFun("0x75a32da6", "roundRobinBlocks()", {}, p.uint256),
    router: viewFun("0xf887ea40", "router()", {}, p.address),
    setApprovesRequired: fun("0x6a0bb81c", "setApprovesRequired(uint256)", {"_approvesRequired": p.uint256}, ),
    setRoundRobinBlocks: fun("0x0d6cf7b0", "setRoundRobinBlocks(uint256)", {"_roundRobinBlocks": p.uint256}, ),
    setWindowSize: fun("0xaaabc315", "setWindowSize(uint256)", {"_windowSize": p.uint256}, ),
    supportsInterface: viewFun("0x01ffc9a7", "supportsInterface(bytes4)", {"interfaceId": p.bytes4}, p.bool),
    unpause: fun("0x3f4ba83a", "unpause()", {}, ),
    windowSize: viewFun("0x8a14117a", "windowSize()", {}, p.uint256),
}
