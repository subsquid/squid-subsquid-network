...
export const events = {
    Claimed: event("0xf7a40077ff7a04c7e61f6f26fb13774259ddf1b6bce9ecf26a8276cdd3992683", "Claimed(address,address,uint256)", {"by": indexed(p.address), "receiver": indexed(p.address), "amount": p.uint256}),
    ...
    WhitelistedDistributorSet: event("0x79420e21e204bc31262bc1cf3cde02641e2f25da501557d80f399b32dad50c17", "WhitelistedDistributorSet(address,bool)", {"distributor": indexed(p.address), "isWhitelisted": p.bool}),
}

export const functions = {
    DEFAULT_ADMIN_ROLE: viewFun("0xa217fddf", "DEFAULT_ADMIN_ROLE()", {}, p.bytes32),
    PAUSER_ROLE: viewFun("0xe63ab1e9", "PAUSER_ROLE()", {}, p.bytes32),
    claim: fun("0x1e83409a", "claim(address)", {"rewardDistribution": p.address}, ),
    claimFor: fun("0xb4ba9e11", "claimFor(address,address)", {"rewardDistribution": p.address, "receiver": p.address}, ),
    claimable: viewFun("0xd4570c1c", "claimable(address,address)", {"rewardDistribution": p.address, "sender": p.address}, p.uint256),
    getRoleAdmin: viewFun("0x248a9ca3", "getRoleAdmin(bytes32)", {"role": p.bytes32}, p.bytes32),
    grantRole: fun("0x2f2ff15d", "grantRole(bytes32,address)", {"role": p.bytes32, "account": p.address}, ),
    hasRole: viewFun("0x91d14854", "hasRole(bytes32,address)", {"role": p.bytes32, "account": p.address}, p.bool),
    isWhitelistedDistributor: viewFun("0xcbccc3e0", "isWhitelistedDistributor(address)", {"_0": p.address}, p.bool),
    pause: fun("0x8456cb59", "pause()", {}, ),
    paused: viewFun("0x5c975abb", "paused()", {}, p.bool),
    reclaimFunds: fun("0xcce4bd52", "reclaimFunds()", {}, ),
    renounceRole: fun("0x36568abe", "renounceRole(bytes32,address)", {"role": p.bytes32, "callerConfirmation": p.address}, ),
    revokeRole: fun("0xd547741f", "revokeRole(bytes32,address)", {"role": p.bytes32, "account": p.address}, ),
    rewardToken: viewFun("0xf7c618c1", "rewardToken()", {}, p.address),
    setWhitelistedDistributor: fun("0xb53c69b6", "setWhitelistedDistributor(address,bool)", {"distributor": p.address, "isWhitelisted": p.bool}, ),
