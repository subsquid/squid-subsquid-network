...
export const events = {
    ...
    NetworkControllerSet: event("0xc933942500e5eabdee8f25e1ce6988211cb77b11019381d0ee10f11ca0a7b76a", "NetworkControllerSet(address)", {"networkController": p.address}),
    RewardCalculationSet: event("0xf0de48adac52cf0a3dedce9122eab2ba78c8418200301785a447bb8c96349c38", "RewardCalculationSet(address)", {"rewardCalculation": p.address}),
    RewardTreasurySet: event("0x52023115ad9f37137d6559cebbde4f5e58fad94c836e496d927ffc3ed958e9d9", "RewardTreasurySet(address)", {"rewardTreasury": p.address}),
    RoleAdminChanged: event("0xbd79b86ffe0ab8e8776151514217cd7cacd52c909f66475c3af44e129f0b00ff", "RoleAdminChanged(bytes32,bytes32,bytes32)", {"role": indexed(p.bytes32), "previousAdminRole": indexed(p.bytes32), "newAdminRole": indexed(p.bytes32)}),
    RoleGranted: event("0x2f8788117e7eff1d82e926ec794901d17c78024a50270940304540a733656f0d", "RoleGranted(bytes32,address,address)", {"role": indexed(p.bytes32), "account": indexed(p.address), "sender": indexed(p.address)}),
    RoleRevoked: event("0xf6391f5c32d9c69d2a47ea670b442974b53935d1edc7fd64eb21e047a839171b", "RoleRevoked(bytes32,address,address)", {"role": indexed(p.bytes32), "account": indexed(p.address), "sender": indexed(p.address)}),
    StakingSet: event("0xf520447191196b125f76f7110397fdf32b1b9cefb7dec323bd3b998022ac2338", "StakingSet(address)", {"staking": p.address}),
    WorkerRegistrationSet: event("0xdab5f283cc831e81a29a9774fa3c356e72198f0d3ae83adb2ccd0c425a236877", "WorkerRegistrationSet(address)", {"workerRegistration": p.address}),
}
...
export const functions = {
    ...
    initialize: fun("0x1459457a", "initialize(address,address,address,address,address)", {"_workerRegistration": p.address, "_staking": p.address, "_rewardTreasury": p.address, "_networkController": p.address, "_rewardCalculation": p.address}, ),
    networkController: viewFun("0x853b97c2", "networkController()", {}, p.address),
    renounceRole: fun("0x36568abe", "renounceRole(bytes32,address)", {"role": p.bytes32, "callerConfirmation": p.address}, ),
    revokeRole: fun("0xd547741f", "revokeRole(bytes32,address)", {"role": p.bytes32, "account": p.address}, ),
    rewardCalculation: viewFun("0x8f0b335e", "rewardCalculation()", {}, p.address),
    rewardTreasury: viewFun("0xc7c934a1", "rewardTreasury()", {}, p.address),
    setNetworkController: fun("0xb7e11add", "setNetworkController(address)", {"_networkController": p.address}, ),
    setRewardCalculation: fun("0xb697fc5a", "setRewardCalculation(address)", {"_rewardCalculation": p.address}, ),
    setRewardTreasury: fun("0xa493415f", "setRewardTreasury(address)", {"_rewardTreasury": p.address}, ),
    setStaking: fun("0x8ff39099", "setStaking(address)", {"_staking": p.address}, ),
    setWorkerRegistration: fun("0x7fc49c94", "setWorkerRegistration(address)", {"_workerRegistration": p.address}, ),
    staking: viewFun("0x4cf088d9", "staking()", {}, p.address),
    supportsInterface: viewFun("0x01ffc9a7", "supportsInterface(bytes4)", {"interfaceId": p.bytes4}, p.bool),
    workerRegistration: viewFun("0xd9ffb4fc", "workerRegistration()", {}, p.address),
}
