...
export const events = {
    Claimed: event("0xa6836ed9f6b0bfa430c6b744cac7cc781c2a5b5be98f6e7ca42d32fd16bc6af3", "Claimed(address,uint256,uint256[])", {"staker": indexed(p.address), "amount": p.uint256, "workerIds": p.array(p.uint256)}),
    Deposited: event("0x1599c0fcf897af5babc2bfcf707f5dc050f841b044d97c3251ecec35b9abf80b", "Deposited(uint256,address,uint256)", {"worker": indexed(p.uint256), "staker": indexed(p.address), "amount": p.uint256}),
    Distributed: event("0xddc9c30275a04c48091f24199f9c405765de34d979d6847f5b9798a57232d2e5", "Distributed(uint256)", {"epoch": p.uint256}),
    EpochsLockChanged: event("0x6d1a1e80fd96834b1293514ebab21ebac9637f9ad7ab1a533a05e4c6929bdd0a", "EpochsLockChanged(uint128)", {"epochsLock": p.uint128}),
    MaxDelegationsChanged: event("0x8c59f6213d7200a03c81eac511632ea48656d94e2bc3b07730bab2e04f5f5286", "MaxDelegationsChanged(uint256)", {"maxDelegations": p.uint256}),
    Paused: event("0x62e78cea01bee320cd4e420270b5ea74000d11b0c9f74754ebdbfc544b05a258", "Paused(address)", {"account": p.address}),
    Rewarded: event("0x6d46424d7308d93179bbc5c8c01e098e8353dad13aff9809fd8a881a69feaa3a", "Rewarded(uint256,address,uint256)", {"workerId": indexed(p.uint256), "staker": indexed(p.address), "amount": p.uint256}),
    ...
    Withdrawn: event("0xcf7d23a3cbe4e8b36ff82fd1b05b1b17373dc7804b4ebbd6e2356716ef202372", "Withdrawn(uint256,address,uint256)", {"worker": indexed(p.uint256), "staker": indexed(p.address), "amount": p.uint256}),
}
...
export const functions = {
    ...
    claim: fun("0x1e83409a", "claim(address)", {"staker": p.address}, p.uint256),
    claimable: viewFun("0x402914f5", "claimable(address)", {"staker": p.address}, p.uint256),
    delegated: viewFun("0x18e44a49", "delegated(uint256)", {"worker": p.uint256}, p.uint256),
    delegates: viewFun("0x587cde1e", "delegates(address)", {"staker": p.address}, p.array(p.uint256)),
    deposit: fun("0xe2bbb158", "deposit(uint256,uint256)", {"worker": p.uint256, "amount": p.uint256}, ),
    distribute: fun("0x8e1b57c5", "distribute(uint256[],uint256[])", {"workers": p.array(p.uint256), "amounts": p.array(p.uint256)}, ),
    epochsLockedAfterStake: viewFun("0x31603b62", "epochsLockedAfterStake()", {}, p.uint128),
    getDeposit: viewFun("0x2726b506", "getDeposit(address,uint256)", {"staker": p.address, "worker": p.uint256}, {"depositAmount": p.uint256, "withdrawAllowed": p.uint256}),
    getRoleAdmin: viewFun("0x248a9ca3", "getRoleAdmin(bytes32)", {"role": p.bytes32}, p.bytes32),
    grantRole: fun("0x2f2ff15d", "grantRole(bytes32,address)", {"role": p.bytes32, "account": p.address}, ),
    hasRole: viewFun("0x91d14854", "hasRole(bytes32,address)", {"role": p.bytes32, "account": p.address}, p.bool),
    lastEpochRewarded: viewFun("0xd760cdd8", "lastEpochRewarded()", {}, p.uint256),
    lockLengthBlocks: viewFun("0xc7ad6dd9", "lockLengthBlocks()", {}, p.uint128),
    maxDelegations: viewFun("0x5612a838", "maxDelegations()", {}, p.uint256),
    pause: fun("0x8456cb59", "pause()", {}, ),
    paused: viewFun("0x5c975abb", "paused()", {}, p.bool),
    renounceRole: fun("0x36568abe", "renounceRole(bytes32,address)", {"role": p.bytes32, "callerConfirmation": p.address}, ),
    revokeRole: fun("0xd547741f", "revokeRole(bytes32,address)", {"role": p.bytes32, "account": p.address}, ),
    router: viewFun("0xf887ea40", "router()", {}, p.address),
    setEpochsLock: fun("0xe03f56e4", "setEpochsLock(uint128)", {"_epochsLock": p.uint128}, ),
    setMaxDelegations: fun("0xe2ef0024", "setMaxDelegations(uint256)", {"_maxDelegations": p.uint256}, ),
    supportsInterface: viewFun("0x01ffc9a7", "supportsInterface(bytes4)", {"interfaceId": p.bytes4}, p.bool),
    token: viewFun("0xfc0c546a", "token()", {}, p.address),
    totalStakedPerWorker: viewFun("0x5f2c3ffe", "totalStakedPerWorker(uint256[])", {"workers": p.array(p.uint256)}, p.array(p.uint256)),
    unpause: fun("0x3f4ba83a", "unpause()", {}, ),
    withdraw: fun("0x441a3e70", "withdraw(uint256,uint256)", {"worker": p.uint256, "amount": p.uint256}, ),
}
