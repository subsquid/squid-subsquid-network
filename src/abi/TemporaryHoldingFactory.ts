...
export const events = {
    ...
    TemporaryHoldingCreated: event("0x0af217c229254446678a1941f87be7df0426ce9e6d5fa96622f67149ae4072f5", "TemporaryHoldingCreated(address,address,address,uint64,uint256)", {"vesting": indexed(p.address), "beneficiaryAddress": indexed(p.address), "admin": indexed(p.address), "unlockTimestamp": p.uint64, "expectedTotalAmount": p.uint256}),
    Unpaused: event("0x5db9ee0a495bf2e6ff9c91a7834c1ba4fdd244a5e8aa4e537bd38aeae4b073aa", "Unpaused(address)", {"account": p.address}),
}

export const functions = {
    DEFAULT_ADMIN_ROLE: viewFun("0xa217fddf", "DEFAULT_ADMIN_ROLE()", {}, p.bytes32),
    HOLDING_CREATOR_ROLE: viewFun("0x93703201", "HOLDING_CREATOR_ROLE()", {}, p.bytes32),
    PAUSER_ROLE: viewFun("0xe63ab1e9", "PAUSER_ROLE()", {}, p.bytes32),
    createTemporaryHolding: fun("0x870541ce", "createTemporaryHolding(address,address,uint64,uint256)", {"beneficiaryAddress": p.address, "admin": p.address, "unlockTimestamp": p.uint64, "expectedTotalAmount": p.uint256}, p.address),
