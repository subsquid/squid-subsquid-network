...
export declare const events: {
    ...
    VestingCreated: import("@subsquid/evm-abi").AbiEvent<{
        readonly vesting: {
            encode: (sink: p.Sink, val: string) => void;
            decode: (src: p.Src) => string;
            isDynamic: boolean;
        ...
        readonly startTimestamp: p.Codec<number | bigint, bigint>;
        readonly durationSeconds: p.Codec<number | bigint, bigint>;
...
export declare const functions: {
    ...
    VESTING_CREATOR_ROLE: import("@subsquid/evm-abi").AbiFunction<{}, p.Codec<string | Uint8Array, string>>;
    createVesting: import("@subsquid/evm-abi").AbiFunction<{
        readonly beneficiaryAddress: p.Codec<string, string>;
        readonly startTimestamp: p.Codec<number | bigint, bigint>;
        readonly durationSeconds: p.Codec<number | bigint, bigint>;
        readonly immediateReleaseBIP: p.Codec<number | bigint, bigint>;
        readonly expectedTotalAmount: p.Codec<number | bigint, bigint>;
