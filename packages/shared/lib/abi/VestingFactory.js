...
exports.events = {
    ...
    VestingCreated: (0, evm_abi_1.event)("0xba477ae50ac3a59d5a6eadd2b0775d90074a7d6bc7a737f2ae874e66dab607f1", "VestingCreated(address,address,uint64,uint64,uint256)", { "vesting": (0, evm_abi_1.indexed)(p.address), "beneficiary": (0, evm_abi_1.indexed)(p.address), "startTimestamp": p.uint64, "durationSeconds": p.uint64, "expectedTotalAmount": p.uint256 }),
};
exports.functions = {
    ...
    VESTING_CREATOR_ROLE: (0, evm_abi_1.viewFun)("0xe9a7fb54", "VESTING_CREATOR_ROLE()", {}, p.bytes32),
    createVesting: (0, evm_abi_1.fun)("0xc623c479", "createVesting(address,uint64,uint64,uint256,uint256)", { "beneficiaryAddress": p.address, "startTimestamp": p.uint64, "durationSeconds": p.uint64, "immediateReleaseBIP": p.uint256, "expectedTotalAmount": p.uint256 }, p.address),
...
class Contract extends evm_abi_1.ContractBase {
    ...
    VESTING_CREATOR_ROLE() {
        return this.eth_call(exports.functions.VESTING_CREATOR_ROLE, {});
    }
    getRoleAdmin(role) {
